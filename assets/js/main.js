...
var Search = /*#__PURE__*/function () {
  ...
  function Search() {
    ...
    this.addSearchHTML();
    this.resultsDiv = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#search-overlay__results");
    this.openButton = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".search__icon");
    this.closeButton = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".search-overlay__close");
    this.searchOverlay = jquery__WEBPACK_IMPORTED_MODULE_2___default()(".search-overlay");
    this.searchField = jquery__WEBPACK_IMPORTED_MODULE_2___default()("#search-term");
    this.events();
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Search, [{
    ...
    value: function events() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(document).on("keydown", this.keyPressDispatcher.bind(this));
    ...
    value: function getResults() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default.a.when(jquery__WEBPACK_IMPORTED_MODULE_2___default.a.getJSON(webrootData.root_url + '/wp-json/wp/v2/posts?search=' + this.searchField.val()), jquery__WEBPACK_IMPORTED_MODULE_2___default.a.getJSON(webrootData.root_url + '/wp-json/wp/v2/pages?search=' + this.searchField.val())).then(function (posts, pages) {
        var combinedResults = posts[0].concat(pages[0]);

        _this.resultsDiv.html("\n        <h2 class=\"search-overlay__section-title\">Resultaten</h2>\n        ".concat(combinedResults.length ? '<ul class="link-list min-list">' : '<p>Geen resultaten die voldoen aan de zoekopdracht<span>!</span></p>', "\n          ").concat(combinedResults.map(function (item) {
          return "<li><a href=\"".concat(item.link, "\">").concat(item.title.rendered, "</a></li>");
        }).join(''), "\n        ").concat(posts.length ? '</ul>' : '', "\n        "));

        _this.isSpinnerVisible = false;
      }, function () {
        _this.resultsDiv.html('<p>Onverwacht resultaat; probeer het opnieuw.</p>');
      });
    }
  }, {
    key: "keyPressDispatcher",
    value: function keyPressDispatcher(e) {
      if (e.keyCode === 83 && !this.isOverlayOpen && !jquery__WEBPACK_IMPORTED_MODULE_2___default()("input, textarea").is(':focus')) {
        this.openOverlay();
      }
    ...
    value: function openOverlay() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("body").addClass("body-no-scroll");
      this.searchField.val('');
      setTimeout(function () {
        return _this2.searchField.focus();
      }, 301); // console.log("Our open method just ran");
    ...
    value: function closeOverlay() {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()("body").removeClass("body-no-scroll"); // console.log("Our close method just ran");
...
var StickyHeader = /*#__PURE__*/function () {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(StickyHeader, [{
    ...
    value: function events() {
      ...
      window.addEventListener("scroll", lodash_throttle__WEBPACK_IMPORTED_MODULE_2___default()(function () {
...
var ptlSearch = new _modules_Search__WEBPACK_IMPORTED_MODULE_2__["default"]();
